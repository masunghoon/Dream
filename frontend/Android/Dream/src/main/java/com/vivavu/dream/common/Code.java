 ...
 */
public class Code {
    final static public int ACT_LOGIN = 1;
    final static public int ACT_MAIN = 2;
    final static public int ACT_ADD_BUCKET = 3;
    final static public int ACT_USER_REGISTER = 4;
    final static public int ACT_INTRO = 5;
    final static public int ACT_RESET_PASSWORD = 6;
